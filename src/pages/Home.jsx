...
const Home = () => {
  ...
  const PHONE = "(414) 313-5597";
  const EMAIL = "	jmhaulllc@gmail.com";
  const MC_NUMBER = "1780997";
  const DOT_NUMBER = "4483496";
  const HOME_BASE = "4048 ANDOVER CAY BLVD ORLANDO, FL 32825";
  ...
  const handleUnlock = (e) => {
    ...
    if (accessCode.toUpperCase() === 'JMHAUL2026') {
      setIsUnlocked(true); setShowModal(false); setError('');
    } else { setError('Invalid Code. Try "JMHAUL2026"'); }
  };
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up z-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-none tracking-tight text-gray-900">
              <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-red-400">JM XPRESS</span> <br />
              HAUL LLC
            </h1>
            
            <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
              <strong>SOUTHEAST ↔ MIDWEST Specialist.</strong> <br/>
           ...
           {/* Image Side */}
            <div className="relative group hover-lift">
              ...
              <div className="absolute bottom-6 left-6 bg-black/80 backdrop-blur-md px-6 py-4 border-l-4 border-red-600 shadow-lg">
                <p className="font-black text-xl uppercase text-white">Josue Martinez</p>
      ...
      <section id="lanes" className="py-20 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['FLORIDA (HQ)', 'GEORGIA', 'ALABAMA', 'TENNESSEE', 'SOUTH CAROLINA', 'NORTH CAROLINA', 'KENTUCKY', 'INDIANA', 'ILLINOIS', 'OHIO', 'MISSOURI'].map((state, index) => (
                <span 
                  key={state} 
                ...
                <div className="bg-white p-1 clip-trap">
                   <form className="grid grid-cols-1 sm:grid-cols-2 gap-2 p-2 bg-white">
                      <select className="bg-gray-100 p-4 font-bold text-gray-700 outline-none focus:bg-gray-200 transition-colors cursor-pointer">
                        <option value="">Origin (Florida / Southeast)</option>
                      ...
                      <select className="bg-gray-100 p-4 font-bold text-gray-700 outline-none focus:bg-gray-200 transition-colors cursor-pointer">
                        <option value="">Destination (Midwest)</option>
